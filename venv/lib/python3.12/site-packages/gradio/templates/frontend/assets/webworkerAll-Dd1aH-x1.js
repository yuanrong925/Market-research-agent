import{E as p,U as ht,T as de,F as ft,x as Re,y as Ue,M as P,l as G,d as Be,K as w,t as R,a9 as re,R as ne,w as q,J as Me,a6 as I,a7 as Ge,c as A,B as C,D as L,ag as he,W as Q,ah as M,m as E,ai as pt,a1 as De,aj as fe,S as V,G as B,H as W,ak as mt,al as ie,O as J,am as k,s as se,a0 as Z,n as Ae,p as ze,ab as ke,ad as Oe,o as gt,q as xt,ac as _t,ae as bt,af as vt,an as yt,ao as Tt,ap as ee,aq as wt,ar as Ct,as as pe,e as y,at as Pt}from"./Index-Dd1rNo_D.js";import{c as Y,a as St,b as Ft,B as Ie}from"./colorToUniform-3MxHuUz8.js";import"./i18n-DhLovEFo.js";import"./index-9Ev7iYt6.js";import"./ImagePreview-DJ7FK62O.js";import"./ScrollFade.svelte_svelte_type_style_lang-ogAEaD61.js";import"./snippet-xbRfGdXG.js";import"./BlockLabel-CqQRDPfZ.js";import"./DownloadLink-hEoT-mAd.js";import"./Empty-B_oS1nZx.js";import"./ShareButton-qU8V1sqI.js";import"./Download-BvDI8Efl.js";import"./Image-BtruDAal.js";import"./IconButtonWrapper-DATTLsrh.js";import"./FullscreenButton-CgU9eLeA.js";import"./Maximize-DX4p_OSq.js";import"./Image-CVAEcPj3.js";import"./ImageUploader-D709Dl1d.js";import"./Clear-D8pztZ4O.js";import"./StreamingBar.svelte_svelte_type_style_lang-D07DuzRz.js";import"./html-CfSn455r.js";import"./index-B_pwUImq.js";import"./actions-DWbx7e_v.js";import"./DropdownArrow-BMS-fktN.js";import"./Square-WO7xGPv5.js";import"./Spinner-BMpW1YeX.js";import"./StreamingBar-DNDaYYJd.js";import"./Upload-yxDsxAyc.js";import"./Block-MCGnkHAA.js";import"./index-BKfLiH8b.js";/* empty css                                              */import"./window-CWHy3o9R.js";import"./tinycolor-egYvDMV9.js";import"./Plus-Cx4pgVJ2.js";import"./input-BhZahYna.js";import"./Check-Co0nFbKx.js";import"./ArrowUp-Bn6JTRK6.js";import"./Trash-D1dcw8zl.js";import"./Undo-DTF74Pc_.js";class Ee{static init(e){Object.defineProperty(this,"resizeTo",{configurable:!0,set(t){globalThis.removeEventListener("resize",this.queueResize),this._resizeTo=t,t&&(globalThis.addEventListener("resize",this.queueResize),this.resize())},get(){return this._resizeTo}}),this.queueResize=()=>{this._resizeTo&&(this._cancelResize(),this._resizeId=requestAnimationFrame(()=>this.resize()))},this._cancelResize=()=>{this._resizeId&&(cancelAnimationFrame(this._resizeId),this._resizeId=null)},this.resize=()=>{if(!this._resizeTo)return;this._cancelResize();let t,r;if(this._resizeTo===globalThis.window)t=globalThis.innerWidth,r=globalThis.innerHeight;else{const{clientWidth:n,clientHeight:i}=this._resizeTo;t=n,r=i}this.renderer.resize(t,r),this.render()},this._resizeId=null,this._resizeTo=null,this.resizeTo=e.resizeTo||null}static destroy(){globalThis.removeEventListener("resize",this.queueResize),this._cancelResize(),this._cancelResize=null,this.queueResize=null,this.resizeTo=null,this.resize=null}}Ee.extension=p.Application;class Ve{static init(e){e=Object.assign({autoStart:!0,sharedTicker:!1},e),Object.defineProperty(this,"ticker",{configurable:!0,set(t){this._ticker&&this._ticker.remove(this.render,this),this._ticker=t,t&&t.add(this.render,this,ht.LOW)},get(){return this._ticker}}),this.stop=()=>{this._ticker.stop()},this.start=()=>{this._ticker.start()},this._ticker=null,this.ticker=e.sharedTicker?de.shared:new de,e.autoStart&&this.start()}static destroy(){if(this._ticker){const e=this._ticker;this.ticker=null,e.destroy()}}}Ve.extension=p.Application;var Rt=`in vec2 aPosition;
